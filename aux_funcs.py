...
def get_err_FCQN(data_tuple1, data_tuple2, agent, gamma, Q_clip):
    curr_state_tuple1, action1, new_state_tuple1, reward1 = data_tuple1
    curr_state_tuple2, action2, new_state_tuple2, reward2 = data_tuple2

    oldQval = agent.network_model.Q_val(curr_state_tuple1, curr_state_tuple2)

    newQval = agent.network_model.Q_val(new_state_tuple1, new_state_tuple2)

    action_tuple1 = action1[0][0], action1[0][1]  # action[0] because action is a nested list of 1 item [[row, col]]
    action_tuple2 = action2[0][0], action2[0][1]
    ...
    TD = ((reward1 + reward2) / 2) + gamma * newQval[np.argmax(newQval)] - ((oldQval[action_tuple1[0] * 52 + action_tuple1[1]] + oldQval[action_tuple2[0] * 52 + action_tuple2[1]]) / 2)
    if Q_clip:
    ...
    Q_target = ((oldQval[action_tuple1[0] * 52 + action_tuple1[1]] + oldQval[action_tuple2[0] * 52 + action_tuple2[1]]) / 2) + Q_step_rate * TD_clip
